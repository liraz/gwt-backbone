...
GwtBackbone v0.4.0 RC (HEAD - no release yet) [![Travis-CI Build Status](https://travis-ci.org/liraz/gwt-backbone.svg?branch=master)](https://travis-ci.org/liraz/gwt-backbone)
===========
